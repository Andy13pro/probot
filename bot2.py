...
notification_chat_id = -4557799595  # Elimina las comillas para que sea un número entero
...
owner_username = 'SerLegacy'
owners = [owner_username, 'yuta_faster', 'SerLegacy', 'Akdios123', 'OKARUN_OV']
...
commands = {
'RENIEC': [
    ("• ONLINE RENIEC", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /c4 51234789\n→ Desc→ Datos C4 y foto del rostro"),
    ("• ONLINE RENIEC", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /c4t 51234789\n→ Desc→ Genera un certificado de inscripción en PDF por DNI"),
    ("• ONLINE RENIEC", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /c4b 51234789\n→ Desc→ Genera una ficha RENIEC blanca en PDF por DNI."),
    ("• ONLINE RENIEC", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /dni 61234578\n→ Desc→ Datos C4"),
        ("• ONLINE RENIEC", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /dnif 61234578\n→ Desc→  foto del rostro, firma y huellas."),
    ("• RENIEC DATABASE (Nivel 2)", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /dnifb 89234567\n→ Desc→ Datos C4, foto del rostro, firma y huellas."),
    ("• RENIEC NOMBRES", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /nm Juan|Perez|Lopez\n→ Desc→ Busca DNI por nombres."),
    ("• ACTA NACIMIENTO", "→ Estado→ ACTIVO\n→ Costo→ 13\n→ Uso→ /actan 93123456\n→ Desc→ Busca actas de nacimiento por DNI"),
    ("• ACTA MATRIMONIO", "→ Estado→ ACTIVO\n→ Costo→ 13\n→ Uso→ /actam 34567812\n→ Desc→ Busca actas de matrimonio por DNI"),
    ("• ACTA DEFUNCION", "→ Estado→ ACTIVO\n→ Costo→ 13\n→ Uso→ /actad 43567218\n→ Desc→ Busca actas de defunción por DNI"),
],
'DELITOS': [
    ("• FISCALIA/MPFN", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /mpfn 24135678\n→ Desc→ Búsqueda fiscal de delitos y agraviaciones por DNI."),
    ("• DETENCIONES", "→ Estado→ ACTIVO\n→ Costo→ 5\n→ Uso→ /detenciones 71456382\n→ Desc→ Busca detenciones de una persona por DNI."),
    ("• ANTECEDENTE PDF", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /antpdf 52413768\n→ Desc→ Busca y genera documento de antecedentes de una persona por DNI."),
    ("• REQUISITORIAS PDF", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /rqpdf 15342689\n→ Desc→ Busca y genera documento de requisitorias de una persona por DNI."),
    ("• RENADESPPLE PDF", "→ Estado→ ACTIVO\n→ Costo→ 8\n→ Uso→ /renadespdf 81234567\n→ Desc→ Busca y genera documentos RENADESPPLE de una persona por DNI."),
    ("• ANTECEDENTES", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /ant 23456789\n→ Desc→ Busca antecedentes de una persona por DNI."),
    ("• REQUISITORIAS", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /rq 78123456\n→ Desc→ Busca requisitorias de una persona por DNI."),
    ("• ANTECEDENTES JUDICIALES", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /antjudver 98765432\n→ Desc→ Busca y genera documentos de antecedentes judiciales de una persona por DNI."),
    ("• ANTECEDENTES POLICIALES", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /antpolver 12345678\n→ Desc→ Busca y genera documentos de antecedentes policiales de una persona por DNI."),
    ("• ANTECEDENTES PENALES", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /antpenver 87654321\n→ Desc→ Busca y genera documentos de antecedentes penales de una persona por DNI."),
],
'SUNARP': [
    ("• SUNARP", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /bienes 97812345\n→ Desc→ Busca propiedades de una persona por DNI."),
    ("• PLACAS", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /placa XYZ123 o 91234567\n→ Desc→ Obtén información de un vehículo mediante el número de placa o DNI."),
    ("• PARTIDA SUNARP", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /partida 56781234\n→ Desc→ Busca y genera partidas SUNARP mediante número de partida."),
],
'GENERADORES': [
    ("• DNI VIRTUAL/DIGITAL", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /dnivir 74561238\n→ Desc→ Genera un DNI virtual (ambas caras) por DNI."),
    ("• DNI VIRTUAL/DIGITAL ELECTRÓNICO", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /dnielec 25617483\n→ Desc→ Genera un DNI virtual electrónico (ambas caras) por DNI."),
    ("• LICENCIA DE CONDUCIR ELECTRÓNICA", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /licencia 67235841\n→ Desc→ Genera licencias de conducir mediante DNI."),
    ("• MOVIMIENTOS MIGRATORIOS PDF", "→ Estado→ ACTIVO\n→ Costo→ 8\n→ Uso→ /migrapdf 38472615\n→ Desc→ Genera PDF de los movimientos migratorios de una persona por DNI."),
    ("• ANTECEDENTES PENALES PDF", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /antpen 52413768\n→ Desc→ Busca y genera documento de antecedentes penales de una persona por DNI."),
    ("• ANTECEDENTES POLICIALES PDF", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /antpol 63456789\n→ Desc→ Busca y genera documento de antecedentes policiales de una persona por DNI."),
    ("• ANTECEDENTES JUDICIALES PDF", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /antjud 74567890\n→ Desc→ Busca y genera documento de antecedentes judiciales de una persona por DNI."),
],
'EXTRA': [
    ("• SUELDOS", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /salario 65432198\n→ Desc→ Busca sueldos de una persona mediante DNI."),
    ("• MOVIMIENTOS MIGRATORIOS", "→ Estado→ ACTIVO\n→ Costo→ 6\n→ Uso→ /migra 89761234\n→ Desc→ Busca movimientos migratorios de una persona por DNI."),
    ("• MTC", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /mtc 34129876\n→ Desc→ Obtén información MTC de una persona mediante DNI."),
    ("• TELEFONOS", "→ Estado→ ACTIVO\n→ Costo→ 2\n→ Uso→ /fono 43219876, /fono 87654321\n→ Desc→ Busca líneas por DNI y titulares por número."),
    ("• TELEFONOS TIEMPO REAL", "→ Estado→ ACTIVO\n→ Costo→ 5\n→ Uso→ /telp 64321890, /telp 987654321\n→ Desc→ Busca líneas de un DNI en tiempo real y titulares por número actualizados hasta 2023."),
    ("• TITULAR BITEL", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /bitx 76329184\n→ Desc→ Busca el titular de un número Bitel en tiempo real."),
    ("• TITULAR CLARO", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /clax 92183647\n→ Desc→ Busca el titular de un número Claro en tiempo real."),
    ("• ARBOL GENEALOGICO", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /arbol 86372415\n→ Desc→ Busca árbol genealógico de una persona por DNI."),
    ("• MINEDU", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /mine 56723489\n→ Desc→ Busca historial de títulos de institutos por DNI."),
    ("• SUNEDU", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /sune 23457816\n→ Desc→ Busca historial de títulos universitarios por DNI."),
    ("• TRABAJOS", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /chanba 52147836\n→ Desc→ Busca historial de trabajos por DNI."),
    ("• TIVE", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /tive XYZ123\n→ Desc→ Obtén información de un vehículo mediante el número de placa."),
    ("• DIRECCIONES", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /dir 94837216\n→ Desc→ Búsqueda de direcciones por DNI."),
    ("• CORREOS", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /doxcorreo 12348976\n→ Desc→ Búsqueda de correos por DNI."),
    ("• FINANCIERO", "→ Estado→ ACTIVO\n→ Costo→ 4\n→ Uso→ /finan 32187654\n→ Desc→ Búsqueda financiera por DNI."),
    ("• AFP", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /afp 67234589\n→ Desc→ Búsqueda de AFP por DNI."),
    ("• SUNAT", "→ Estado→ ACTIVO\n→ Costo→ 3\n→ Uso→ /sunat 39182756\n→ Desc→ Búsqueda SUNAT por RUC o DNI."),
    ("• MIGRACIONES", "→ Estado→ ACTIVO\n→ Costo→ 1\n→ Uso→ /ce 789123456\n→ Desc→ Búsqueda de personas extranjeras por CE."),
    ("• CÉDULA VENEZOLANA", "→ Estado→ ACTIVO\n→ Costo→ 1\n→ Uso→ /cve 00001 o /cve 32897112\n→ Desc→ Búsqueda de personas de Venezuela mediante cédula."),
    ("• NOMBRES VENEZUELA", "→ Estado→ ACTIVO\n→ Costo→ 1\n→ Uso→ /nmve JUAN|LOPEZ|MENDOZA\n→ Desc→ Búsqueda de personas de Venezuela mediante nombres."),
           ]
}
...
async def show_menu(chat_id, user_id, event=None):
    if event:
        ...
        await event.edit(
            ...
            text=(
                "🔍 **PISSLING DOX - INVESTIGA LO DESCONOCIDO** 🔍\n\n"
                "🛠️ **Desbloquea comandos diseñados para descubrir información oculta.** 🛠️\n\n"
                "💡 **Explora cada sección y accede a datos que pocos conocen.** 💡\n\n"
                "➡️ **Elige una sección para comenzar tu investigación.** ⬅️"
            ),
            buttons=[
                [Button.inline("📂 RENIEC", f"RENIEC_0_{user_id}"), Button.inline("⚖️ DELITOS", f"DELITOS_0_{user_id}")],
                [Button.inline("🏛️ SUNARP", f"SUNARP_0_{user_id}"), Button.inline("📃 GENERADORES", f"GENERADORES_0_{user_id}")],
                [Button.inline("📦 EXTRA", f"EXTRA_0_{user_id}")],
                [Button.inline("🏠 Menú Principal", f"main_menu_{user_id}")]
            ]
        )
    else:
...
def create_pagination_buttons(section, page, user_id):
    ...
    if page > 0:
        buttons.append(Button.inline("⬅️ Anterior", f"{section}_{page-1}_{user_id}"))

    # Botón "Menú Principal"
    buttons.append(Button.inline("🏠 Menú Principal", f"main_menu"))

    # Botón "Siguiente" si hay más comandos después de la página actual
    if (page + 1) * 6 < total_commands:
        buttons.append(Button.inline("➡️ Siguiente", f"{section}_{page+1}_{user_id}"))
            ...
            if key in button_states:
                ...
                if button_states[key]:  # Si se selecciona
                    if key == "button_akdios":
                        selected_buttons.append(Button.url("🍂 Akdios123", "https://t.me/Akdios123"))
                    elif key == "button_group":
                        selected_buttons.append(Button.url("🌐 Grupo Principal", "https://t.me/pisllingdox"))
                    elif key == "button_serlegacy":
                        selected_buttons.append(Button.url("🌟 SerLegacy", "https://t.me/SerLegacy"))
                    elif key == "button_yuta":
...
async def update_buttons_ui(callback_event, button_states):
    buttons = [
        [
            Button.inline(f"Botón a @Akdios123{' (Seleccionado)' if button_states['button_akdios'] else ''}", b"button_akdios"),
            Button.inline(f"Botón al Grupo{' (Seleccionado)' if button_states['button_group'] else ''}", b"button_group")
        ],
        [
            Button.inline(f"Botón a @SerLegacy{' (Seleccionado)' if button_states['button_serlegacy'] else ''}", b"button_serlegacy"),
...
async def buy(event):
    buy_text = """
    🇵🇪 | 🌑 **Pislling DOX - CRÉDITOS & PLANES** 🌑

    ✨ **Precios de Créditos** ✨

    🔹 **30 CRÉDITOS** ➤ **S/ 7 SOLES**  
    🔹 **110 CRÉDITOS** ➤ **S/ 12 SOLES**  
    🔹 **280 CRÉDITOS** ➤ **S/ 22 SOLES**  
    🔹 **450 CRÉDITOS** ➤ **S/ 35 SOLES**  
    🔹 **590 CRÉDITOS** ➤ **S/ 45 SOLES**  
    🔹 **1500 CRÉDITOS** ➤ **S/ 90  SOLES**  

    🌟 **Precios de Planes VIP** 🌟

    💎 **7 DÍAS VIP** ➤ **S/ 10 SOLES**  
    💎 **15 DÍAS VIP** ➤ **S/ 18 SOLES**  
    💎 **30 DÍAS VIP** ➤ **S/ 35 SOLES**  
    💎 **60 DÍAS VIP** ➤ **S/ 60 SOLES**  

    🏅 **VENDEDORES OFICIALES** 🏅
    """

    buttons = [
        [Button.url("🍂 AKdios", "https://t.me/Akdios123")],
        [Button.url("😺 OKARUN", "https://t.me/OKARUN_OV")]
...
cooldowns = {
    "default": 10,  # Cooldown estándar en segundos
...
async def handle_special_commands(event, command):
    ...
    if command == '/start':
        ...
        if not user_data["registered"]:
            await event.reply("¡Bienvenido ! Para comenzar, por favor regístrate usando el comando /register.", parse_mode='markdown')
        else:
            await event.reply("Ya estás registrado y tienes acceso completo a los comandos del bot.", parse_mode='markdown')
...
"""
                ...
                await event.reply("⚠️ Por favor, configura tu nombre de usuario en Telegram para poder registrarte.")
                print("Intento de registro sin nombre de usuario")
        else:
            await event.reply("📋 Ya estás registrado para usar los comandos del bot.", parse_mode='markdown')
...
𝗔𝗡𝗧𝗜-𝗦𝗣𝗔𝗠: {user_data.get('anti_spam', 0)}
...
async def forward_response(event):
    ...
    consultado_por = f"\n\n👁 𝗖𝗢𝗡𝗦𝗨𝗟𝗧𝗔𝗗𝗢 𝗣𝗢𝗥:\n   [{user_info_id.get('first_name')} {user_info_id.get('last_name')}](tg://user?id={user_info_id.get('id')})"
    ...
    while True:
        ...
        for username, data in all_data.items():
            ...
            if premium_end_date and parse_date(premium_end_date) <= current_date:
                if data["warnings"] < 3:
                    data["warnings"] += 1
                    notification_message = f"🔔 Notificación: El acceso premium de @{username} expirará pronto. Se ha enviado una advertencia."
                else:
                    data["premium_start"] = None
                    data["premium_end"] = None
                    update_user_data(username, data)
                    notification_message = f"🔔 Notificación: El acceso premium de @{username} ha expirado."
...
async def handle_private_message(event):
    ...
    if not has_premium and user_data['coins'] <= 0:
        await event.reply(
            "No tienes un plan premium activo o suficientes créditos para usar los comandos del bot.",
            buttons=[
                [Button.url("Comprar Créditos", "https://t.me/akdios123")],
                [Button.url("😺 OKARUN", "https://t.me/OKARUN_OV")],
                [Button.inline("Ver Precios", b"ver_precios")]
            ],
            parse_mode='markdown'
        )
        return
        ...
        if command in command_translation:
            ...
            if command in command_costs:
                ...
                if sender.username not in owners and not has_premium and user_data['coins'] < cost:
                    await event.reply(
                        "⚠️ No tienes suficientes créditos para usar este comando. Por favor, compra más créditos o verifica los precios disponibles.",
                        buttons=[
                            [Button.url("Comprar Créditos", "https://t.me/akdios123")],
                            [Button.url("😺 OKARUN", "https://t.me/OKARUN_OV")],
                            [Button.inline("Ver Precios", b"ver_precios")]
            ...
            try:
                # Enviar mensaje al bot de origen
                entity = await client.get_input_entity(leo_vidal_username)
                sent_message = await client.send_message(entity, message)

                # Incrementar el contador de consultas
                user_data["queries"] += 1
                update_user_data(sender.username, user_data)  # Guardar los datos actualizados
            ...
            # Limpiar archivos descargados (si los hubiera)


            # Verificar si el mensaje contiene imágenes o multimedia
            downloaded_files = []
            if event.message.media:
            ...
            try:
                # Enviar mensaje al bot de origen (si tiene imágenes adjuntas, se enviarán también)
                entity = await client.get_input_entity(leo_vidal_username)

                # Si hay archivos descargados (imágenes), enviarlos junto con el texto
                if downloaded_files:
...
async def show_prices(event):
    ...
    🔹 **40 CRÉDITOS** ➤ **S/ 7 SOLES**  
    🔹 **111 CRÉDITOS** ➤ **S/ 12 SOLES**  
    🔹 **260 CRÉDITOS** ➤ **S/ 20 SOLES**  
    🔹 **480 CRÉDITOS** ➤ **S/ 35 SOLES**  
    🔹 **590 CRÉDITOS** ➤ **S/ 45 SOLES**  
    🔹 **1500 CRÉDITOS** ➤ **S/ 90 SOLES**  

    🌟 **Precios de Planes VIP** 🌟

    💎 **10 DÍAS VIP** ➤ **S/ 15 SOLES**  
    💎 **15 DÍAS VIP** ➤ **S/ 18 SOLES**  
    💎 **30 DÍAS VIP** ➤ **S/ 35 SOLES**  
    💎 **60 DÍAS VIP** ➤ **S/ 60 SOLES**  
    ...
    buttons = [
        [Button.url("🍂 AKdios123", "https://t.me/Akdios123")],
        [Button.url("😺 OKARUN", "https://t.me/OKARUN_OV")]
